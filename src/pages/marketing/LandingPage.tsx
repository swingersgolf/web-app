...
const ExpandYourNetwork = () => {
    return (
        <div id="expand-your-network" className="flex flex-row w-full items-start justify-center py-24 gap-x-32">
            <div id="expand-your-network-text-container" className="flex flex-col w-2/3 gap-y-8">
            ...
            <div id="expand-your-network-image-container" className="flex w-1/3">
...
const DiscoverThePower = () => {
    return (
        <div id="discover-the-power" className="flex flex-row w-full items-start justify-center py-24 gap-x-32">
            <div id="discover-the-power-text-container" className="flex flex-col w-2/3 gap-y-8">
                <div className="flex flex-col gap-y-2">
            ...
            <div id="discover-the-power-image-container" className="flex w-1/3">
