...
const Caption = ({ text, route }: CaptionProps) => {
    ...
    return (
        <div id="caption" className="flex flex-row items-center justify-start text-caption text-xs font-normal w-fit rounded-full px-3 py-1  bg-dark bg-opacity-30 border border-opacity-10 border-dark backdrop-blur">
